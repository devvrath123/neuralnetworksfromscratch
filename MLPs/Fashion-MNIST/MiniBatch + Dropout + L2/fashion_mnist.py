...
neuralnet = [
    ...
    Leaky_ReLU(),
    Dropout(0.2), # Drops 20% of connections during training
    Dense(128, 64),
    Leaky_ReLU(),
    Dropout(0.2), 
    Dense(64, 10),
...
print("Multi-Layer Perceptron (Dense Neural Network) with MiniBatch + dropout + L2 reg. + exponential learning rate decay + momentum based backward propagation")
train(neuralnet, cce, cce_prime, X_train, Y_train, iter=100, lr=0.01, decay=0.0005)
